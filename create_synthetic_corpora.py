...
TOTAL_N_CORPORA = 50 #in total, we want to create TOTAL_N_CORPORA for each setting
N_WORDS = 200 # each document contains 200 words
N_DOCS = 2000 # create 2000 documents per setting
